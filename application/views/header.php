								  	...
								  	<div class="container-fluid">
								  		<div class="row">
								  			<div class="col-sm-6 col-lg-6">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pesemaian')); ?>" style="margin-top: 10px;">Pesemaian</a>	
								  				<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pemupukan')); ?>">Pemupukan</a>
							          			<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
							          			<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pengendalian Penyakit')); ?>">Pengendalian Penyakit</a>
							          			<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
							          			<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pengendalian Hama')); ?>" style="margin-bottom: 8px;">Pengendalian Hama</a>
							          			<!-- <hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
									          	<a href="<?php echo base_url() ?>teknologibudidaya/pengendalianPenyakit" style="margin-bottom: 8px;">Panen dan Pasca Panen</a> -->
								  			</div>
								  			<div class="col-sm-6 col-lg-6">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Panen dan Pasca Panen')); ?>" style="margin-top: 10px;">Panen dan Pasca Panen</a>	
								  				<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Kesesuaian Lahan')); ?>">Kesesuaian Lahan</a>	
								  				<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Sorting dan Grading')); ?>">Sorting dan Grading</a>	
								  				<hr style="margin: 4px 0px 5px 0px; border-color: rgba(28,69,26,1);">
								  				<a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Morfologi dan Biologi')); ?>">Morfologi dan Biologi</a>
								  			</div>
								  		</div>							  		
								  	</div>							  								          
							  	</div>
				    ...
				    <div class="collapse navbar-collapse" id="main">			    
					    <ul class="nav navbar-nav navbar-right hidden-md hidden-lg" style="margin-top: 8px;margin-right: 75px;">
					      	...
					      	<li class="dropdown">
						        ...
						        <ul class="dropdown-menu">
						        	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pesemaian')); ?>">Pesemaian</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pemupukan')); ?>">Pemupukan</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pengendalian Penyakit')); ?>">Pengendalian Penyakit</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Pengendalian Hama')); ?>">Pengendalian Hama</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Panen dan Pasca Panen')); ?>">Panen dan Pasca Panen</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Kesesuaian Lahan')); ?>">Kesesuaian Lahan</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Sorting dan Grading')); ?>">Sorting dan Grading</a></li>
						          	<li><a href="<?php echo base_url('teknologibudidaya/index/').urlencode(strtolower('Morfologi dan Biologi')); ?>">Morfologi dan Biologi</a></li>
