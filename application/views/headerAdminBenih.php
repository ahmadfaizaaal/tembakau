				    ...
				    <div class="collapse navbar-collapse">			    
					    <ul class="nav navbar-nav navbar-right" style="margin-top: 10px;margin-right: 0px;">
					      	...
					      	<div class="dropdownHeader">							  								  	
							  	<a href="<?php echo base_url('admin/logoutBenih'); ?>" style="text-decoration-line: none;"><div class="dropbtnHeader" style="font-family: Minion Pro; cursor: pointer;">Logout &nbsp<i class="glyphicon glyphicon-log-out" style="font-size:14px;"></i></div></a>
							</div>																			      		     
					    </ul>				    
				    </div>				    
				</div>
